...
const skills = ["TypeScript", "React.js", "Next.js"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Software Engineer", "Full-Stack Developer", "Happy coding!"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Building modern, clean, and responsive web experiences. Turning
              ideas and designs into impactful digital products with precision
